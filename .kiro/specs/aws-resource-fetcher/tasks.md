...
- [ ] 5. VPC Fetcher 구현
- [ ] 5.1 VPCFetcher 클래스 구현 (fetchers/vpc.py)
  - fetch_vpcs 메서드 구현
...
- [ ] 6. SecurityGroup Fetcher 구현
- [ ] 6.1 SecurityGroupFetcher 클래스 구현 (fetchers/security_group.py)
...
- [ ] 7. 통합 리소스 조회 인터페이스 구현
- [ ] 7.1 ResourceFetcher 클래스 구현 (resource_fetcher.py)
